//
//  AccountSummarySkeletonTableViewCell.swift
//  Bankfan
//
...
extension AccountSummarySkeletonTableViewCell: SkeletonLoadable {}

class AccountSummarySkeletonTableViewCell: UITableViewCell {
    ...
    static let identifier = "AccountSummarySkeletonTableViewCell"
...
extension AccountSummarySkeletonTableViewCell {
    ...
    private func setup() {
        ...
        let chevronImage = UIImage(systemName: "chevron.right")!.withTintColor(.Asset.primary, renderingMode: .alwaysOriginal)
